...
- Set up a Poetry project with the following structure:
  - src/
    - __init__.py
    - main.py
  - tests/
...
Configure the project using Poetry with the following dependencies:
- pydantic: For data validation and settings management
- python-dotenv: To load environment variables from a .env file
- litellm: OpenAI API wrapper for model interactions

Additionally, include the following development tools:
